  ...
  return (
    <div className="mx-auto w-full max-w-[1440px]">
      ...
      <header className="mb-6">
        <h1 className="heading-lg text-petcenter-text">Đăng ký hồ sơ thú cưng</h1>
        <p className="body-md mt-1 max-w-2xl text-petcenter-text-secondary">
          Nhập thông tin chính xác để trung tâm nhận diện, theo dõi cân nặng và chuẩn bị chăm sóc phù hợp.
        </p>
      </header>
...
function buildCreatePayload(form: FormState): CreatePetInput {
  return {
...
function NumberWithSuffixField({
  ...
  return (
    <label className="block" htmlFor={name}>
      ...
      {disabled ? (
        <span className="body-sm mt-1 block text-petcenter-text-muted">
          Đã có ngày sinh, không cần nhập tuổi ước tính.
        </span>
      ) : null}
    </label>
  )
