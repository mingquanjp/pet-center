...
import { SearchX, RotateCcw, PawPrint } from "lucide-react";

interface Props {
  onReset: () => void;
}

export function StaffBoardingEmptyState({ onReset }: Props) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center animate-in fade-in duration-500">
      ...
      <h3 className="heading-sm text-petcenter-text mb-2">Không tìm thấy bản ghi lưu trú phù hợp</h3>
